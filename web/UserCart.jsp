  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <!-- End Content Slider -->
        ...
        ArrayList<Integer> phoneCartQtyList = new ArrayList<Integer>();
            ...
            while(rs.next()){
                ...
                phoneCartQtyList.add(phoneCartQty);
            ...
            session.setAttribute("phoneIdList", phoneIdList);
            session.setAttribute("phoneCartQtyList", phoneCartQtyList);
            %>
            <tr>
